...
function initNodeEditor() {
    NE.view = this.document.getElementById("editor_view");
    NE.canvas = this.document.getElementById("canvas");
...
function editorViewReset() {
    ...
    CS.windowH = NE.editorView.style.height = window.innerHeight + "px";
    CS.windowW = NE.editorView.style.width = window.innerWidth + "px";
}

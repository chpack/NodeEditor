...
function scale(times) {
    ...
    // NE.editorArea.style.transformOrigin = CS.mouseX + "px " + CS.mouseY + "px"
    minimapResize()
    minimapReplace()
    CS.scale = NE.scaleLevel[CS.scaleindex]
    NE.editorArea.style.transform = "scale(" + CS.scale + "," + CS.scale + ")"
}

function minimapResize() {
    // console.log( NE.editorArea.width.slice(0,-3) * CS.minimapRate + "px");
    // console.log( NE.editorArea.offsetWidth);
